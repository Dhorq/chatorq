...
const ProfilePage = () => {
  ...
  return (
    <div className="min-h-screen bg-cover bg-no-repeat flex items-center justify-center">
      <div className="w-5/6 max-w-2xl backdrop-blur-2xl text-gray-300 border-2 border-gray-600 items-center justify-between flex max-sm:flex-col-reverse rounded-lg">
        <form
